<template>
  <div class="index" v-loading.fullscreen.lock="fullscreenLoading" element-loading-text="拼命加载中...">
    ...
    <el-table :data="excelData" tooltip-effect="dark">
      ...
      <el-table-column label="经度" prop="size" show-overflow-tooltip></el-table-column>
      <el-table-column label="纬度" prop="taste" show-overflow-tooltip></el-table-column>
      <el-table-column label="评价" prop="price" show-overflow-tooltip></el-table-column>
      ...
      importFile: function () { // 导入excel
        ...
        reader.onload = function (e) {
          ...
          for (let i = 0;i < json.length; i++) {
            ...
            let lng = json[i].size;
            let lat = json[i].taste;

            geo = lng.concat(a, lat);
            point.push({
              name,geo
            })
          }
